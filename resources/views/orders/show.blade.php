              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-sm-10 invoice-col">
                    <b>Nama Supplier:</b> <br>{{$order->supplier->name}} <br>
                    {{-- <div class="row-invoice-info"> --}}
                      <b>Alamat: </b>
                  ...
                  <!-- /.col -->
                  <div class="col-sm-2 invoice-col">
                    <b>No P.O: </b>{{$order->no_po}} <br>
                    <b>Tanggal Order:</b> {{$order->created_at}}<br>
                    <b>Maksimal Kirim:</b> {{$order->deadline}}<br>
                    <br>
                  </div>
                  <!-- /.col -->
                </div>
