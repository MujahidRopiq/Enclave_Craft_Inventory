@extends('layouts.table') @section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="/material1s/create" class="btn btn-primary">Tambah
                        Material 1</a>
                </div>
            </div>
        </div>
    ...
    <form action="/material1s" method="get" id="form-order-by-name">
    ...
    <form action="/material1s" method="get" id="form-order-by-sku">
        <input type="hidden" name="search" value="{{ request('search') ?? '' }}" />
    ...
    <form action="/material1s" method="get" id="form-order-by-date">
        <input type="hidden" name="search" value="{{ request('search') ?? '' }}" />
