@extends('layouts.table') @section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Daftar Material 2</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="/material2s/create" class="btn btn-primary">Tambah
                        Material 2</a>
                </div>
            </div>
        </div>
                                            ...
                                            <td class="project-actions text-right">
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <form
                                                        ...
                                                        @method('delete')
                                                        <button
                                                            onclick="return confirm('PERHATIAN!!!\nSemua furniture yang menggunakan material 2 {{ $data->name }} juga akan terhapus.')"
    ...
    <form action="/material2s" method="get" id="form-order-by-name">
    ...
    <form action="/material2s" method="get" id="form-order-by-sku">
        <input type="hidden" name="search" value="{{ request('search') ?? '' }}" />
    ...
    <form action="/material2s" method="get" id="form-order-by-date">
        <input type="hidden" name="search" value="{{ request('search') ?? '' }}" />
