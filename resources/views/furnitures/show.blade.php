                ...
                <div class="card card-dark card-outline p-3">
                    ...
                    <form action="/images" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-sm-10">
                                <button class="btn btn-primary" id="add-image">Tambah gambar</button>
                        ...
                        <button type="reset" id="reset" class="btn btn-secondary d-none">Batal</button>
                        <button type="submit" id="submit" class="btn btn-primary d-none">Simpan</button>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-end">
                        ...
                        <form action="/images/{{ $data->id }}" method="post">
                            @csrf
                            @method('delete')
                            <button onclick="return confirm('Hapus gambar!')" type="submit" class="btn btn-danger">Hapus
                                gambar</button>
                        </form>
                    </div>
                </div>
